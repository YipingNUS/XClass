...
python3 document_class_alignment.py --dataset_name ${dataset} --pca 160
...
python3 evaluate.py --dataset ${dataset} --stage Align --suffix pca160.clusgmm.bbu-12.mixture-100.42

echo "EXECUTING: prepare_text_classifer_training.py"
python3 prepare_text_classifer_training.py --dataset_name ${dataset} --suffix pca160.clusgmm.bbu-12.mixture-100.42
